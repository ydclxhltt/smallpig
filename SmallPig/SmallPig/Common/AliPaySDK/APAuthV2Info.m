...
- (NSString *)description
{
    ...
    NSArray *decriptionArray = @[[NSString stringWithFormat:@"app_id=\"%@\"", self.appID],
                                 ...
                                 [NSString stringWithFormat:@"app_name=\"%@\"", self.appName?self.appName:@"SmallPig"],
                                 ...
                                 [NSString stringWithFormat:@"scope=\"%@\"", self.scope?self.scope:@""],
                                 [NSString stringWithFormat:@"target_id=\"%@\"", self.targetID?self.targetID:@"201503301330"],
                                 [NSString stringWithFormat:@"auth_type=\"%@\"", self.authType?self.authType:@"AUTHACCOUNT"],
                                 [NSString stringWithFormat:@"sign_date=\"%@\"", self.signDate?self.signDate:@"2015-03-30 13:30:00"]];
